...
{
    Camera2D cam;
    float hole_time; //How much time has passed since the hole started, and it is needed to detrmine how much time a player takes to finish a hole
} RenderState;

void RenderInit(RenderState *r, Vector2 ball_pos);
